...
map.station <- function (x = NULL, stid = NULL, param = NULL, lon = NULL, lat = NULL, 
                         ...
                         FUN=NULL,from=NULL,to=NULL,cex.lab=1,...) 
{ 
  ...
  if (TRUE) {  
      if (!is.null(FUN)) {
          ...
          col.bar(breaks,col=COL,type="p",v=2,h=1,cex=cex.lab)
  ...
  title(xlab = "Longitude (Degrees-East)",line=2.2 , cex.lab = 0.8) 
  title(ylab = "Latitude (Degrees-North)",line=2.2 , cex.lab = 0.8) 
                                        # format axes
  axis(1,seq(xlim[1],xlim[2],by=10),cex.axis=.7)
  axis(2,seq(ylim[1],ylim[2],by=10),cex.axis=.7)
  axis(4,seq(ylim[1],ylim[2],by=10),cex.axis=.7)
  axis(3,seq(xlim[1],xlim[2],by=10),cex.axis=.7)
