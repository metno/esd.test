...
x <- rbind(c("101" , "Mean temperature"		 	, "0.1"   		, "degC" 	, "T"),
	   c("111" , "Mean maximum temperature"	 	, "0.1"   		, "degC" 	, "Tx"), 
 	   c("112" , "Highest maximum temperature"  	, "0.1"   		, "degC" 	, "Th"),
	   c("113" , "Day of Th" 			, "1"     		, "date", "Thd"),
	   c("121" , "Mean minimum temperature" 	, "0.1"   		, "degC" 	, "Tn"),
	   c("122" , "Lowest minimum temperature" 	, "0.1"   		, "degC"	, "Tl"),
...
x <- rbind(c("601" , "Precipitation amount"		, "0.1"	  		, "mm"	, "RR"),
	   ...
	   c("111" , "Maximum temperature" 	 	, "0.1"   		, "degC" 	, "TX"),
	   c("121" , "Minimum temperature" 		, "0.1"	  		, "degC" 	, "TN"),
	   c("101" , "Mean temperature" 		, "0.1"   		, "degC" 	, "TG"))
...
ghcnm.ele <- function() {
x <- rbind(c("101" , "monthly mean temperature"	 	, "0.01" 		, "degC" , "TAVG"), 
	   c("111" , "monthly maximum temperature"  	, "0.01" 		, "degC" , "TMAX"),
	   c("121" , "monthly minimum temperature"  	, "0.01" 		, "degC" , "TMIN"))
...
x <- rbind(c("601" , "Precipitation"		 	, "0.1"	  		, "mm"	, "PRCP"),
	   ...
	   c("111" , "Maximum temperature" 	 	, "0.1"   		, "degC"	, "TMAX"),
	   c("121" , "Minimum temperature" 	 	, "0.1"	  		, "degC" 	, "TMIN"))
...
metno.ele <- function() { ## must be updated - AM 2014-02-21
  ...
  x <- rbind(c("601" , "Precipitation"		 	, "1"	  		, "mm"	, "RR"),
             c("999" , "Snowfall"			, "1" 	  		, "mm" 	, "SNOW"),
             c("901" , "Snow depth"			, "1" 	  		, "mm" 	, "SNWD"),
             c("101" , "Mean temperature"	        , "1" 		        , "degC", "TAM"),
             c("111" , "Maximum temperature" 	 	, "1"   		, "degC", "TAX"),
             c("121" , "Minimum temperature" 	 	, "1"	  		, "degC", "TAN"))
